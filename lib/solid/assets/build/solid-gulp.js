var gulp          = require('gulp'),
    ...
    SolidSass     = require('./tasks/scss'),
    SolidUglify   = require('./tasks/uglify'),
    SolidBabel    = require('./tasks/babel'),
    SolidCss      = require('./tasks/css'),
    SolidConcat   = require('./tasks/concat'),
    SolidVersion  = require('./tasks/version'),
    lib           = require('./lib.js');
...
var solidGulp = {
    ...
    babel: function (key) {
        return new SolidBabel(key, options, configurable.config);
    },

    sass: function (key) {
        return new SolidSass(key, options, configurable.config);
    },
    ...
    version: function () {
        return new SolidVersion(options, configurable.config);
    },

    task: function (name, tasks, callback) {
        ...
        if (configurable.config.isLocal) {
            livereload.listen()
        }
    },
    ...
    isLocal: function () {
        return configurable.config.isLocal
    }
