...
var storm_path = path.normalize(__dirname + '/../../../../modules/system/assets/')
...
var config = {
    ...
    concat : {
        vendor : [
            ...
            basepath   + "vendor/jquery.min.js",
            storm_path + "js/framework.js",
            storm_path + "js/framework.extras.js",
            ...
            '!' + basepath + "vendor/framework/js/*.js",
